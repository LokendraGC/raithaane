...
<div class="rts-chop-details-area rts-section-gap bg_light-1">
    ...
    <?php if( $feat_image ) { ?>
        <div class="thumb-wrapper <?php echo esc_attr($count); ?> filterd-items <?php echo esc_attr($hide); ?>">
    ...
    <div class="product-thumb-filter-group">
        <?php if( $feat_image ) { ?>
            <div class="thumb-filter filter-btn <?php echo esc_attr($active); ?>" data-show=".<?php echo esc_attr($count); ?>">
                <img src="<?php echo esc_url( $feat_image[0] ); ?>"
                     alt="<?php echo esc_attr(get_the_title()); ?>">
            </div>
            <?php 
        ...
        ?>
									...
									<?php }else{ ?>
										<div class="product-thumb-area">
                                            ...
                                            <div class="thumb-wrapper one filterd-items figure">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                                    style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/default.svg)"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/default.svg" alt="product-thumb">
                                                </div>
                                            </div>
                                            
                                            <div class="product-thumb-filter-group">
                                                <div class="thumb-filter filter-btn active" data-show=".one"><img
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/images/default.svg" alt="product-thumb-filter"></div>
                                            </div>
                                        </div>
										<?php } ?>
									<div class="contents">										
									...
									<?php if (the_content() != '') { ?>
										...
										<div class="product-uniques">
											...
											<form action="<?php echo esc_url( home_url() ).'/whole-sale-form/'; ?>" method="POST">
											<div class="buy-wholesale">
												...
												<button type="submit" class="rts-btn btn-primary radious-sm with-icon" style="background:#2359c1">
					...
					if( $wtn_faqs && $product_description ){
					?>
							...
							<div class="swiper-slide">
								<div class="single-shopping-card-one">
									...
									<?php }else{ ?>
										...
										<a href="<?php the_permalink(); ?>" class="thumbnail-preview">
											<img src="<?php echo get_template_directory_uri(). '/assets/images/default.svg'; ?>" alt="<?php the_title(); ?>" alt="<?php the_title(); ?>">
										</a>
